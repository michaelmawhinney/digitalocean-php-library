...
* `deleteKeyById(int $key_id)` *_or_* `destroyKeyById(int $key_id)`
* `deleteKeyByFingerprint(string $key_fingerprint)` *_or_* `destroyKeyByFingerprint(string $key_fingerprint)`
